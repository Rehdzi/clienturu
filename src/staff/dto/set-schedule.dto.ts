...
import { ArrayNotEmpty, IsArray, IsInt, Matches, Max, Min, ValidateNested } from 'class-validator';
...
export class SetScheduleDto {
  @ApiProperty({
    description: "Full weekly working hours (replaces the master's existing schedule)",
